...
const Hero = () => {
  ...
  return (
    <div ref={heroRef} className="relative h-screen w-screen overflow-x-hidden">
      {loading && (
      ...
      <div id="video-frame" className="relative z-10 h-full w-screen overflow-hidden bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100">
