...
const ContactPage = () => {
  ...
  <AnimatedTitle
    ...
    className="special-font !text-5xl md:!text-7xl !font-black !leading-[1] bg-gradient-to-r from-rose-700 via-pink-700 to-rose-800 bg-clip-text text-transparent mb-6 drop-shadow-lg"

  />
  <p className="text-xl text-gray-950 max-w-2xl mx-auto leading-relaxed tracking-wide">
